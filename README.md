...
launch from the command line:
    ...
    $ lein run -m hanoi-visualizer.web
...
get the app created:
    ...
    $ heroku apps:create hanoi-visualizer
    Creating hanoi-visualizer... done, stack is cedar
    http://hanoi-visualizer.herokuapp.com/ | git@heroku.com:hanoi-visualizer.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://hanoi-visualizer.herokuapp.com deployed to Heroku

    To git@heroku.com:hanoi-visualizer.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://hanoi-visualizer.herokuap.com
    ["Hello" :from Heroku]
